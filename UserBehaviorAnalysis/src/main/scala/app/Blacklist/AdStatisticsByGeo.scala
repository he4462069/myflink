...
object AdStatisticsByGeo {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val adLogStream: DataStream[AdClickLog] = env.readTextFile("D:\\IdeaProjects\\myflink\\UserBehaviorAnalysis\\src\\main\\resources\\Data\\AdClickLog.csv")
      .map(data => {
